...
Neuinfektionen seid Februar 2020:
...
Testdata_Cleaner%>%
  ...
  theme_minimal()+
  geom_line(color="midnightblue") +
  labs(titel = "",x="Datum",y="Anzahl Neuinfektionen" ) 
```
...
SteamCharts %>%
  ...
  geom_point(size = 3) +
  theme_minimal()+
  labs(x=NULL,y="durschnittliche Spieleranzahl in Tausend",color="Jahr") +
  scale_y_continuous(limits=c(0,150000), breaks=c(0,50000,100000,150000),labels = c("0", "50","100", "150")) -> Plot_A
...
SteamCharts %>%
  ...
  theme_minimal()+
  labs(x=NULL,y="durschnittliche Spieleranzahl in Tausend",color="Jahr") +
  scale_y_continuous(limits=c(0,150000), breaks=c(0,50000,100000,150000),labels = c("0", "50","100", "150")) -> Plot_B
```
...
SteamCharts %>%
  ...
  theme_minimal()+
  labs(x=NULL,y="durschnittliche Spieleranzahl in Tausend",color="Jahr") +
  scale_y_continuous(limits=c(300000,900000), breaks=c(300000,400000,500000,600000,700000,800000,900000),labels = c("300", "400","500", "600","700","800","900"))
```
