...
Neuinfektionen seit Februar 2020:
...
Testdata_Cleaner%>%
  ...
  theme_minimal()+
  geom_line(color="midnightblue") +
  labs(title = "Covid-19 Neuinfektionen im Jahre 2020",x=NULL,y="Anzahl Neuinfektionen" ) 
```
...
SteamCharts %>%
  ...
  scale_y_continuous(limits=c(0,150000), breaks=c(0,50000,100000,150000),labels = c("0", "50","100", "150")) -> plot_1
...
SteamCharts %>%
  ...
  geom_point(size = 3) +
  theme_minimal()+
  labs(title="Terraria",x=NULL,y=NULL,color="Jahr") +
  scale_y_continuous(limits=c(0,150000), breaks=c(0,50000,100000,150000),labels = c("0", "50","100", "150")) -> plot_2
```
...
(plot_1 + plot_2)/plot_3 +
  plot_annotation(title = "Beliebte Spiele im Vergleich: Durchschnittliche Spieleranzahl pro Monat
                  ...
                  ")
```
# Gaming rettet Dein Leben x2

1. Wenn Du Zuhause bleibst, ist das Risiko dich anzustecken geringer.
